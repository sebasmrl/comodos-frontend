  ...
  return (
    <div className="grid grid-cols-12 gap-2 px-2 md:px-6 pt-4">
      ...
      <div className="col-span-12 md:col-span-8 flex flex-col">
        ...
        <UserAdCardItemsContainer className="col-span-12 grid grid-cols-12 gap-4 p-2 border-none">
          {
            ads.map(ad => (
      ...
      <section className="col-span-12 md:col-span-4 md:col-start-9 flex flex-col gap-2 py-2 px-2 items-start">
