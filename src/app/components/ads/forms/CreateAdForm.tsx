...
import { createAdFormSchema, createAdFormSchemaDefaultValues } from "./schemas/create-ad-form-schema";
        ...
        >
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className={cn("p-4 w-full grid grid-cols-12 gap-6 sm:px-20 md:px-4 ", className)}>
                    ...
                    <Button type="submit" variant={'success'} className="self-end mt-4 mb-6 w-full col-span-12  lg:col-span-10 lg:col-start-2"><IoIosAddCircle /> Crear Anuncio</Button>
                </form>
            </Form>
        </div>
    )
